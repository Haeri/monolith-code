...
async function _setFileInfo(filePath) {
  file.extension = await window.api.path.extname(filePath);
  file.path = await window.api.path.dirname(filePath) + window.api.path.sep;
  file.name = await window.api.path.basename(filePath, file.extension);
